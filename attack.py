...
from utils.utils_attack import eval_attack
...
def main(args, config):
    ...
    eval_attack(model, m_tokenizer, ref_model, tokenizer, test_loader, images_normalize, clean_sims_dict, device, args, config, PATH_EXP)
